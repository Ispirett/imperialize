<template>
  <div class="item">
    ...
    >
      <sui-image :src="image" />
      <!--                https://lasentinel.net/wp-content/uploads/sites/5/2016/02/rel-deonkipping-album-cover.jpg-->
      <sui-dimmer blurring :active="cardOneActive">
        <sui-button inverted @click="playSong">
...
.item {
  color: lightgray;
  background-color: rgba(4, 5, 14, 0.14);
  width: 46em;
  display: flex;
  flex-direction: row;
  align-items: center;
